...
namespace Instrucoes
{
    class Program
    {
        ...
        {
            int a; //declaração de variável sem um vaor
            int b = 2, c = 3; //Declaração especificando valores
            const int d = 4;
            a = 1;
        ...
        //O break é muito usado em laços de repetição/ O Breal sai do While
        ...
        // Outro exemplo d estrutura condicional
